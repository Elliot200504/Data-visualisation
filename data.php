...
if (!isset($_SESSION['data'])) {
    $_SESSION['data'] = ["Recordings"=>12, "Arbeten"=>25, "Errors"=>8];
}
if (!isset($_SESSION['details'])) {
    $_SESSION['details'] = [
        "Recordings"=>["labels"=>["Mon","Tue","Wed","Thu","Fri"],"values"=>[2,3,1,4,2]],
...
if (!isset($_SESSION['users'])) {
    $_SESSION['users'] = [
        ["id"=>1,"name"=>"Anna Svensson","role"=>"Technician","last_login"=>"2025-09-11 08:42","logs"=>["Logged in","Visited Dashboard","Tried creating a recording","Logged out"]],
